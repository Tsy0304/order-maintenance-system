...
<div id="home" class="nav-bar">
    <nav class="nav-box">
        ...
        <a class="nav-list" onclick="staff()">Staff<div class="nav-active"></div></div></a>
...
<div class="container">
    <?php 
        ...
        $result = $mysqli->query("SELECT * FROM staff") or die($mysqli_error);
        //pre_r($result);
        ?>
        <br><p style="font-size:20px; color:green;">Manage Staff Details:</p><br>
            ...
            <table class="table table-align">
                <thead>
                    <tr>
                        ...
                        <th><a href="addstaff.php?outlet=<?php echo $selectedOutlet; ?>"
        ...
        <?php
            while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <a href="editstaff.php?staffID=<?php echo $row['staffID']; ?>&outlet=<?php echo $selectedOutlet; ?>"
                            class="btn btn-info">Edit</a>
                            <a href="staff.php?deletestaff=<?php echo $row['id']; ?>&outlet=<?php echo $selectedOutlet; ?>"
