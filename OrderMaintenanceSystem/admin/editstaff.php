...
if (isset($_GET['staffID'])) {
  ...
  $staffID = 'd'; // Replace with your default value
}
?>
<?php
...
$GetProd = "SELECT * FROM staff WHERE staffID='$staffID'";
...
<!-- Main Content -->
  <div class="background" style="height: 1010px">
    <h1>Edit Staff</h1>
      <div id="error"></div>
          <!--Shipping Info -->
          <form class="form" id="ship&bill-form" action="editstaffdatabase.php?staffID=<?=$staffID?>&outlet=<?php echo $selectedOutlet; ?>" method="POST" autocomplete="on">
          <div>
              <div class="div-container">
                <div class="left-div" >
                  ...
                  <div class="form-control">
                    ...
                    <input type="text" value="<?=$productGroup['staffID']?>" id="staffID" name="staffID" placeholder="" required>
                    <small>Error message</small>
                  </div>

                  <div class="form-control">
                    <label for="name">Name: </label>
                    <input type="text" value="<?=$productGroup['name']?>" id="name" name="name" placeholder="" required>
                    <small>Error message</small>
                  </div>

                  <div class="form-control">
                    <label for="department">Department: </label>
                    <input type="text" value="<?=$productGroup['department']?>" id="department" name="department" placeholder="" required>
                    <small>Error message</small>
                  </div>

                  <div class="form-control">
                    <label for="Email">Email: </label>
                    <input type="text" value="<?=$productGroup['email']?>" id="email" name="email" placeholder="" required>
                    <small>Error message</small>
                  </div>

                  <div class="form-control">
                    <label for="phonenumber">Phone Number(+60): </label>
                    <input type="text" value="<?=$productGroup['phonenumber']?>" id="phonenumber" name="phonenumber" placeholder="" required>
                    <small>Error message</small>
                  </div>

                  <div class="form-control">
                    <label for="outlets">Outlets: </label>
                    <input type="text" value="<?=$productGroup['outlets']?>" id="outlets" name="outlets" placeholder="" required>
                    <small>Error message</small>
                  </div>
