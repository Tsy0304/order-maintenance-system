...
<div id="home" class="nav-bar">
    <nav class="nav-box">
        ...
        <a class="nav-list" onclick="book()">Book<div class="nav-active"></div></a>
...
<div class="container">
    <?php 
        ...
        //pre_r($result);
        ?>
        <br><p style="font-size:20px; color:green;">Manage Book Details:</p><br>
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th><a href="addbook.php?outlet=<?=$selectedOutlet?>"
        ...
        <?php
            while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                    <a href="editbook.php?bookID=<?php echo $row['bookID']; ?>&outlet=<?php echo $selectedOutlet; ?>" 
